 ...
 *
 * @param dst       The destination for the table entries that have been read
 *                  and parsed from the specified source file descriptor.
 *
 * @param src_fd    The file descriptor that will be used for reading and
